# mainscene2bundle 1.1 by Just gemer, credits:augustodoidin,kirbymasta
# Original idea: Rama
...
platform = str(input('Platform?(pc, nx): '))
...
<root>
    ...
    # unpacking jdu bundle
    os.makedirs('output//temp', exist_ok=True)
    subprocess.call('bin\\quickbms "bin\\scriptIPKextract.bms" "input\\'+mapnamelow+'_main_scene_nx.ipk" "output\\temp\\')
    # importing files
    src_files= os.listdir('output//temp//world//maps//'+mapnamelow+'//timeline//moves//wiiu')
    for file_name in src_files:
        full_file_name= os.path.join('output//temp//world//maps//'+mapnamelow+'//timeline//moves//wiiu', file_name)
        if os.path.isfile(full_file_name):
            shutil.copy(full_file_name, 'output//'+mapnamelow+'_nx//world//maps//'+mapnamelow+'//timeline//moves//wiiu')
    src_files= os.listdir('output//temp//cache//itf_cooked//nx//world//maps//'+mapnamelow+'//timeline//pictos')
    for file_name in src_files:
        full_file_name= os.path.join('output//temp//cache//itf_cooked//nx//world//maps//'+mapnamelow+'//timeline//pictos', file_name)
        if os.path.isfile(full_file_name):
            shutil.copy(full_file_name, 'output//'+mapnamelow+'_nx//cache//itf_cooked//nx//world//maps//'+mapnamelow+'//timeline//pictos')
    src_files= os.listdir('input//textures')
    for file_name in src_files:
        full_file_name= os.path.join('input//textures', file_name)
        if os.path.isfile(full_file_name):
    ...
    os.rmdir('output//temp//cache//itf_cooked//nx//world//maps//'+mapnamelow+'//cinematics')
    os.rmdir('output//temp//cache//itf_cooked//nx//world//maps//'+mapnamelow+'//graph')
    os.rmdir('output//temp//cache//itf_cooked//nx//world//maps//'+mapnamelow+'//menuart//actors')
    os.rmdir('output//temp//cache//itf_cooked//nx//world//maps//'+mapnamelow+'//menuart//textures')
    os.rmdir('output//temp//cache//itf_cooked//nx//world//maps//'+mapnamelow+'//timeline//pictos')
    os.rmdir('output//temp//cache//itf_cooked//nx//world//maps//'+mapnamelow+'//videoscoach')
